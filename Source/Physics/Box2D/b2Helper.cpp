...
static b2Vec2 screenSpaceToBox2dSpace(float aX, float aY)
{
  return b2Vec2(b2Helper::screenSpaceToBox2dSpace(aX), b2Helper::screenSpaceToBox2dSpace(aY));
}

static b2Vec2 screenSpaceToBox2dSpace(b2Vec2 aValue)
{
...
static b2Vec2 box2dSpaceToScreenSpace(float aX, float aY)
{
  return b2Vec2(b2Helper::box2dSpaceToScreenSpace(aX), b2Helper::box2dSpaceToScreenSpace(aY));
}

static b2Vec2 box2dSpaceToScreenSpace(b2Vec2 aValue)
{
