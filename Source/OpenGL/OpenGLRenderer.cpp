...
{
  setBackgroundColor(OpenGLColorRed());
  setForegroundColor(OpenGLColorBlue());
  m_DefaultFont = new OpenGLFont(OPENGL_FONT_DEFAULT_FONT, OPENGL_FONT_DEFAULT_SIZE, OPENGL_FONT_EXTENDED_CHARACTER_SET);
}
